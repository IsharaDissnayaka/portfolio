...
function App() {
  return (
    <div
      className="overflow-x-hidden text-neutral-100 antialiased selection:text-cyan-900 bg-zinc-950 min-h-screen"
      style={{
    ...
    >
      ...
      <div className="container mx-auto mt-24 px-4 bg-black bg-opacity-70 min-h-screen">
        <section id="home">
        <Main />
        </section>
        <section id="about">
